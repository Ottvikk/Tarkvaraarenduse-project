...
mõõk = pygame.image.load("Mõõk.png")#Lisame pildi
mõõk = pygame.transform.scale(mõõk, [80, 100])#Pildi asukoht
screen.blit(mõõk,[0,150])#Pildi suurus
vikklogo = pygame.image.load("vikklogo.png")#Lisame pildi
